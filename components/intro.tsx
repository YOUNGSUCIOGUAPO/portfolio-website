  ...
  return (
    <section
     ...
     className="mb-28 max-w-[50rem] text-center sm:mb-0 scroll-mt-[100rem]">
      ...
      <motion.h1 className="mb-10 mt-4 px-4 text-2xl font-medium !leading-[1.5] ms:text-4xl"
      initial={{ opacity: 0, y:100 }}
      animate={{ opacity: 1, y:0 }}
      >
        <span className="font-bold">
          {" "}
          Hi, I'm David, I'm a software engineer based in New York.
        </span>{" "}
      ...
      >
        ...
        borderBlack dark:bg-white/10" href='/CV.pdf' download>
        Download CV <HiDownload className="opacity-60 group-hover:translate-y-1 transition"/></a>

        <a className="bg-white px-7 p-4 text-gray-700 hover:text-gray-950 flex items-center gap-2 rounded-full
        focus:scale-[1.15] hover:scale-[1.15] active:scale-105 transition cursor-pointer
        borderBlack dark:bg-white/10 dark:text-white/60" href="htpps://linkedin.com" target="_blank" ><BsLinkedin /></a>

        <a className="bg-white px-7 p-4 text-gray-700 flex items-center gap-2 text-[1.35rem] rounded-full
        focus:scale-[1.15] hover:scale-[1.15] hover:text-gray-950 active:scale-105 transition cursor-pointer
        borderBlack dark:bg-white/10 dark:text-white/60" href="htpps://github.com" target="_blank">
          <FaGithubSquare />
        </a>
      </motion.div>
    </section>
